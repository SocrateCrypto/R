...
int main(void)
{
  ...
  /* creation of HidTask */
  HidTaskHandle = osThreadNew(HidTaskFnc, NULL, &HidTask_attributes);
  ...
  printf("Im braikpoint 1\r\n");
  NRF24_ini();
  printf("Im braikpoint 2\r\n"); // Initialize NRF24L01
  NRF24_DebugInfo();             // Debugging information for NRF24
  printf("Im braikpoint 3\r\n");
